...
<section class="w-full bg-azul mt-8 pt-32 lg:pt-36 pb-6 lg:pb-8 lg:pb-8 lg:bg-contain bg-left-top lg:bg-bottom bg-no-repeat " style="background-image: url('<?php bloginfo('template_url') ?>/dist/img/bg_azul_franja.png');">
    <div class=" w-5/6 lg:w-1/2 mx-auto text-center relative">
        <h1 class="text-beige font-festivo6 text-4xl lg:text-5xl uppercase">Mis Talleres</h1>   
    </div>
</section>

<section class="mt-12">
    <div class="container mx-auto justify-between px-8 lg:px-32">
        @loop
        {{ the_content() }}
        @endloop
        @php
