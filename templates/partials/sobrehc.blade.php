        ...
        <div class="grid grid-cols-12 gap-4 lg:gap-12">
            ...
            <div class="bg-naranjo col-start-1 col-span-12 pt-12 px-4 -mt-32 lg:mt-0  lg:col-span-5 mb-8">
                <div class="relative mt-3">
                    ...
                    <a href="#" class="h-12 w-full lg:w-9/12 leading-12 text-center inline-block border border-negro border-solid text-negro hover:bg-negro hover:border-negro hover:text-beige transition duration-200">
                        MÁS SOBRE HERENCIA COLECTIVA
                    </a>
                </div>
            </div>
        </div>
