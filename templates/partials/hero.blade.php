...
<div class="flex items-center bg-negro relative">
    ...
    <img src="<?php bloginfo('template_url') ?>/dist/img/rayas.svg" alt="rayas" class="absolute w-1/3 lg:w-1/6">
    <div class="w-full h-48 bg-gradient-to-t from-transparent to-black absolute bottom-0 left-0"></div>
