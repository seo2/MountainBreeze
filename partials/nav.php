...
?>
  ...
  <div class="flex container max-w-screen-xl mx-auto items-center justify-between flex-row lg:px-24">
    <nav class="flex-grow md:pb-0 flex justify-between lg:justify-start flex-row uppercase">
      <a class="px-4 lg:px-8 py-4 lg:mt-2 <?php if(is_home()){ ?> text-naranjo <?php }else{ ?> text-gris <?php } ?> text-sm font-sans bg-transparent rounded-none md:mt-0 md:mr-1 hover:text-naranjo focus:text-naranjo focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-200" href="<?php bloginfo('url'); ?>/">Mi inicio</a>
      <a class="px-4 lg:px-8 py-4 lg:mt-2 <?php if(is_page("mis-talleres")){ ?> text-naranjo <?php }else{ ?> text-gris <?php } ?> text-sm font-sans bg-transparent rounded-none md:mt-0 md:mr-1 hover:text-naranjo focus:text-naranjo focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-200" href="<?php bloginfo('url'); ?>/mis-talleres">Mis talleres</a>
      <a class="px-4 lg:px-8 py-4 lg:mt-2 <?php if(is_page("mis-proyectos")){ ?> text-naranjo <?php }else{ ?> text-gris <?php } ?> text-sm font-sans bg-transparent rounded-none md:mt-0 md:mr-1 hover:text-naranjo focus:text-naranjo focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-200" href="<?php bloginfo('url'); ?>/mis-proyectos  ">Mis proyectos</a>
      <a class="px-4 lg:px-8 py-4 lg:mt-2 <?php if(is_page("favoritos")){ ?> text-naranjo <?php }else{ ?> text-gris <?php } ?> text-sm font-sans bg-transparent rounded-none md:mt-0 md:mr-1 hover:text-naranjo focus:text-naranjo focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-200" href="<?php bloginfo('url'); ?>/favoritos">Favoritos</a>
      <a class="px-4 lg:px-8 py-4 lg:mt-2 <?php if(is_page("mensajes")){ ?> text-naranjo <?php }else{ ?> text-gris <?php } ?> text-sm font-sans bg-transparent rounded-none md:mt-0 md:mr-1 hover:text-naranjo focus:text-naranjo focus:bg-gray-200 focus:outline-none focus:shadow-outline transition duration-200" href="<?php bloginfo('url'); ?>/mis-talleres">Mensajes</a>
    </nav>
