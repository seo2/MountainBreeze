...
<div class="w-full py-4 bg-fondooscuro border-b border-gris2">
    ...
    <div class="flex container flex-row max-w-screen-xl px-4 mx-auto lg:items-center justify-left md:px-6 lg:px-8">
        <div class="p-4 flex flex-row lg:items-center justify-between">
        ...
        <div class="lg:p-4 flex flex-row lg:items-center justify-between">
            <ul class="self-end">
    ...
    <p class="text-gris3 lg:hidden text-center mt-8">Herencia Colectiva 2020 ®</p>
</div>
...
<?php echo $__env->yieldContent('inline_scripts'); ?>

</body>
</html><?php /**PATH /Users/Seo2/Dropbox/04 - Diseño y Desarrollo/00 - En desarrollo/01 - Sitios/herenciacolectiva/wp-content/themes/mountainbreeze/templates/partials/footer.blade.php ENDPATH**/ ?>