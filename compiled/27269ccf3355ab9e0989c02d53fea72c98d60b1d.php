            ...
            <div class="col-start-2 col-span-10 lg:mb-8">
                <div class="grid grid-cols-12 gap-4">
                    <div class="col-span-6 lg:col-span-3 mb-8">
                        <div class="relative">
                            <img src="<?php bloginfo('template_url') ?>/dist/img/maestre1.png" alt="pan">
                        </div>
                        <div class="relative mt-3">
                            <h4 class="text-negro text-xl lg:text-2xl font-bold lg:font-festivo6 leading-none mt-3 mb-1">Wini Walbaum</h4>
                            <p class="text-naranjo text-sm uppercase">Cultivo</p>
                        </div>
                    </div>
                    <div class="col-span-6 lg:col-span-3 mb-8">
                        <div class="relative">
                            <img src="<?php bloginfo('template_url') ?>/dist/img/maestre2.png" alt="pan">
                        </div>
                        <div class="relative mt-3">
                            <h4 class="text-negro text-xl lg:text-2xl font-bold lg:font-festivo6 leading-none mt-3 mb-1">12na</h4>
                            <p class="text-naranjo text-sm uppercase">Diseño</p>
                        </div>
                    </div>
                    <div class="col-span-3 mb-8 hidden lg:block">
                        <div class="relative">
                            <img src="<?php bloginfo('template_url') ?>/dist/img/maestre3.png" alt="pan">
                        </div>
                        <div class="relative mt-3">
                            <h4 class="text-negro text-2xl font-bold font-festivo6 leading-none mt-3 mb-1">Pan Batido</h4>
                            <p class="text-naranjo text-sm uppercase">Panadería</p>
                        </div>
                    </div>
                    <div class="col-span-3 mb-8 hidden lg:block">
                        <div class="relative">
                            <img src="<?php bloginfo('template_url') ?>/dist/img/maestre4.png" alt="pan">
                        </div>
                        <div class="relative mt-3">
                            <h4 class="text-negro text-2xl font-bold font-festivo6 leading-none mt-3 mb-1">La despensa del ratón</h4>
                            <p class="text-naranjo text-sm uppercase">Gastronomía</p>
                        </div>
                    </div>
...
</div><?php /**PATH /Applications/MAMP/htdocs/herenciacolectiva/wp-content/themes/mountainbreeze/templates/partials/maestres.blade.php ENDPATH**/ ?>