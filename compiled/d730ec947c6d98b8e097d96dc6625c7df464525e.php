...
<section class="w-full bg-fondooscuro <?php if(is_user_logged_in()): ?> pt-48 <?php else: ?> pt-36 <?php endif; ?> pb-24 lg:pb-12 lg:bg-cover bg-bottom bg-no-repeat " style="background-image: url('<?php bloginfo('template_url') ?>/dist/img/Fondo_Negro_1.png');" id="elCambio">
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12">
            <div class="col-start-2 col-span-10 lg:col-start-2 lg:col-span-3">
                <h1 class="text-beige font-festivo6 text-5xl lg:text-6xl uppercase mb-5"><?php the_title(); ?></h1>
                <?php the_content(); ?>
            </div>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>  
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/Seo2/Dropbox/04 - Diseño y Desarrollo/00 - En desarrollo/01 - Sitios/herenciacolectiva/wp-content/themes/mountainbreeze/templates/page-elcambio.blade.php ENDPATH**/ ?>