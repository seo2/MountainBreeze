				...
				<div class="copyright_wrap copyright_style_<?php echo esc_attr($copyright_style); ?>  scheme_<?php echo esc_attr(lorem_ipsum_books_media_store_get_custom_option('copyright_scheme')); ?>">
					<div class="copyright_wrap_inner">
						<div class="content_wrap">
							...
							?>
							<div class="copyright_text"><?php lorem_ipsum_books_media_store_show_layout(do_shortcode(str_replace(array('{{Y}}', '{Y}'), date('Y'), lorem_ipsum_books_media_store_get_custom_option('footer_copyright')))); ?></div>
						</div>
					</div>
				</div>
				<?php
