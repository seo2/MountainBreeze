...
if (!function_exists('lorem_ipsum_books_media_store_post_type_save_options')) {
	function lorem_ipsum_books_media_store_post_type_save_options($post_id) {
		...
		$post_options = array_merge((array)lorem_ipsum_books_media_store_storage_get('options'), lorem_ipsum_books_media_store_storage_get_array('post_override_options', 'fields'));
