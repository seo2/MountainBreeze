...
if ( !function_exists( 'lorem_ipsum_books_media_store_get_sidebar_class' ) ) {
	function lorem_ipsum_books_media_store_get_sidebar_class() {
		...
		$empty = !is_active_sidebar(lorem_ipsum_books_media_store_get_custom_option('sidebar_main'));

		return ((lorem_ipsum_books_media_store_param_is_off($sb_main) || $empty) ? 'sidebar_hide' : 'sidebar_show sidebar_'.($sb_main))
