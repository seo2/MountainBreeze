	...
	if ( !function_exists( 'lorem_ipsum_books_media_store_admin_load_scripts' ) ) {
		function lorem_ipsum_books_media_store_admin_load_scripts() {
			...
			if (lorem_ipsum_books_media_store_check_admin_page('widgets.php')) {
				wp_enqueue_style( 'fontello-style', lorem_ipsum_books_media_store_get_file_url('css/fontello-admin/css/fontello-admin.css'), array(), null );
				wp_enqueue_style( 'fontello-animations-style', lorem_ipsum_books_media_store_get_file_url('css/fontello-admin/css/animation.css'), array(), null );
			}
