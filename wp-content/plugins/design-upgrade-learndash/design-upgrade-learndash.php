 ...
 */
define( 'LDX_DESIGN_UPGRADE_LEARNDASH_VERSION', '2.8.3' );
...
function ldx_design_upgrade_learndash_enqueue_css() {
	...
	if ( 'legacy' === $template ) {
		...
		wp_enqueue_style( 'ldx-design-upgrade-learndash', plugins_url( 'assets/css/ld3.css', __FILE__ ), array( 'learndash_quiz_front_css', 'learndash-front' ), '2.8.3' );
