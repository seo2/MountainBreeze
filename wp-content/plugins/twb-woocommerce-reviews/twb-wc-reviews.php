...
function twb_wc_reviews_scripts() {
		wp_enqueue_style( 'twb_wc_reviews_styles', TWB_WC_REVIEWS_URL. 'inc/css/twb_wc_reviews_main.css', array(), null, 'all' );
		//wp_enqueue_style( 'twb_wc_reviews_dynamic_styles', TWB_WC_REVIEWS_URL. 'inc/css/twb_wc_reviews_dynamic.php', array(), null, null, 'all' );
		wp_enqueue_style( 'twb_wc_reviews_slick_css', TWB_WC_REVIEWS_URL . 'inc/css/slick.css', array(), null, 'all' );
...
require_once TWB_WC_REVIEWS_DIR . 'twb_wc_reviews_functions.php';